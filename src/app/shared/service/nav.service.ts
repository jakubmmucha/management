...
export class NavService {
  ...
  MENUITEMS: Menu[] = [
    {
      title: 'About us', type: 'link',
    },
    {
      title: 'E-commerce', type: 'link', path: 'landing', children: [
        {
          title: 'Gym equipment',  type: 'sub', children: [
               { path: '/towers', title: 'No Sidebar',  type: 'link' },
               { path: '/safety', title: 'Left Sidebar',  type: 'link' },
