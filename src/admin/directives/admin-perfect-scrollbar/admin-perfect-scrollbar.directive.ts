...
import { AdminPerfectScrollbarGeometry, AdminPerfectScrollbarPosition } from 'src/admin/directives/admin-perfect-scrollbar/admin-perfect-scrollbar.interfaces';
import { AdminConfigService } from 'src/admin/services/config.service';

@Directive({
    selector: '[adminPerfectScrollbar]'
})
export class AdminPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy {
     ...
     * @param prefix
     */
    geometry(prefix: string = 'scroll'): AdminPerfectScrollbarGeometry {
        return new    AdminPerfectScrollbarGeometry(
     ...
     * @param absolute
     */
    position(absolute: boolean = false): AdminPerfectScrollbarPosition {
        if ( !absolute && this.ps ) {
            return new AdminPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        } else {
