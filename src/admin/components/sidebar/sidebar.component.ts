import {ChangeDetectorRef, Component, ElementRef, EventEmitter,
  HostBinding, HostListener, Input, OnDestroy, OnInit, Output, Renderer2, ViewEncapsulation
} from '@angular/core';
...
import { AdminMatchMediaService } from 'src/admin/services/match-media.service';
...
export class AdminSidebarComponent implements OnInit, OnDestroy {
    ...
    private _showBackdrop(): void {
        ...
        this._backdrop.classList.add('admin-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay ) {
            this._backdrop.classList.add('admin-sidebar-overlay-invisible');
        }
