...
export class AdminWidgetComponent implements AfterContentInit {
    @HostBinding('class.flipped')
    flipped = false;

    @ContentChildren(AdminWidgetToggleDirective, {descendants: true})
    toggleButtons: QueryList<AdminWidgetToggleDirective>;
