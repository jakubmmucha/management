...
import '/../projects/admin/components/highlight/prism-languages';
...
export class AdminHighlightComponent implements OnInit, OnDestroy {
    // Source
    ...
    highlight(sourceCode): void {
        ...
        // can be formatted properly while using admin-highlight
        // component
