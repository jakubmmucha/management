...
export class AdminThemeOptionsComponent implements OnInit, OnDestroy {
    fuseConfig: any;
    form: FormGroup;
            ...
            case 'vertical-layout-1': {
                this.form.patchValue({
                    layout: {
                        width    : 'fullwidth',
                        navbar   : {
                            primaryBackground  : 'admin-navy-700',
                            secondaryBackground: 'admin-navy-900',
                            folded             : false,
                            hidden             : false,
                            position           : 'left',
                        ...
                        toolbar  : {
                            background           : 'admin-white-500',
                            customBackgroundColor: false,
                            hidden               : false,
                            position             : 'below-static'
                        },
                        footer   : {
                            background           : 'admin-navy-900',
