...
import { MatColors } from '/../projects/admin/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const FUSE_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide    : NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => AdminMaterialColorPickerComponent),
    multi      : true
};
...
export class AdminMaterialColorPickerComponent implements ControlValueAccessor {
    colors: any;
    hues: string[];
    view: string;
    selectedColor: any;
    ...
    set color(value) {
        ...
        // Split the color value (red-400, blue-500, admin-navy-700 etc.)
