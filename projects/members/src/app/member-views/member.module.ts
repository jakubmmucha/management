...
import {UserMembersService} from '../_services-members/user-members.service';
import {AuthMembersService} from '../_services-members/auth-members.service';
import {LoginComponent} from './login/login.component';
import {ProfileDetailsService} from './account-page/profile-details/profile-details.service';
...
@NgModule({
  ...
  declarations: [GymComponent, ProfileDetailsComponent, FormsComponent, LoginComponent, PersonalInformationComponent,
    CheckoutComponent, BreadcrumbBigTypographyComponent, SignUpComponent, AccountViewComponent, GymNavComponent, GymHeaderComponent,
    GymAboutComponent, GymScheduleComponent, GymWorkoutAboutComponent, GymCounterComponent, GymTrainerComponent,
    GymTestimonialComponent, GymPricingComponent, TabsComponent, GymBMIComponent, GymBrandComponent, GymFooterComponent,
    GymCopyrightComponent, EcommerceHeaderComponent, GymInsideGymPageComponent, GymInsideGymPageComponent,
    GymMembershipPageComponent, GymOpeningTimesPageComponent, GymBlogPageComponent, GymShopPageComponent,
    TryComponent, TabsComponent, ProfileDetailsComponent],
